...
public class DialogoManagerBoss : MonoBehaviour
{
    public static DialogoManagerBoss instancia;
    ...
    public void MostrarDialogo(string[] lineas, Action callback)
    {
